               ...
               arr.push(this.list[i])
                ...
                var delist = []
                 for(var i = 0; i< this.moneyList.length;i++){
                    this.proList.push(this.moneyList[i].orderItem.orderItems[0])
                      //  delist.push(this.moneyList[i].orderItem.orderItems)
                 }
